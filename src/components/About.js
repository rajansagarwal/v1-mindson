...
class About extends Component {
	render() {
		return (
			...
			<Row>
			<Col sm={12}>
					<h3 className="highlights">Highlights</h3></Col>
					<Col sm={12}>
			<h4>
			...
			🧠 We want to know how we can <a className="spanlink" href="https://google.com">make Minds On better</a></h4></Col>
			</Row>
			<Row>
			<Col sm={6}>
			<h3>About</h3>
			<h4>Everyone is affected by mental hhhh.</h4>
			</Col>
		<Col sm={6}>
		<br/>
